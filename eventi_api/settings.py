"""
Django settings for eventi_api project.
...
SECRET_KEY = 'django-insecure-sf3y7h-@(5553_d018s^ijj(y-yem@lxdg=y!#g#2vu&8-y6+h'
...
ASGI_APPLICATION = 'eventi_api.asgi.application'
WSGI_APPLICATION = 'eventi_api.wsgi.application'
